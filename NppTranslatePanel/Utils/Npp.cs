...
namespace NppTranslatePanel.Utils
{
    ...
    public class Npp
    {
        ...
        /// but under some weird circumstances (see this GitHub issue comment: https://github.com/molsonkiko/NppNppTranslatePanel/issues/5#issuecomment-1982167513)<br></br>
        /// it can fail.
        /// </summary>
